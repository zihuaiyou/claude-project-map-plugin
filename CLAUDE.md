...
_上次更新: 2026-06-19 | 架构版本: 1 | _git_ref: c03d826_
...
- `mcp/project-map-server/src/index.ts` — 入口，创建 server，注册 tool handlers
...
- `mcp/project-map-server/src/types.ts` — 共享类型定义
...
## Conventions
- MCP Server 按职责拆模块（scan / analyze / detect / arch / types），index.ts 只做编排
